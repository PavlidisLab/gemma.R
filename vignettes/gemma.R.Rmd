...
To access the actual expression data in a convenient form, you can use [`getDataset()`](https://pavlidislab.github.io/gemma.R/reference/getBioc.html).
...
Alternatively, you can use [`getDatasetExpression()`](https://pavlidislab.github.io/gemma.R/reference/getDatasetData.html) to only get the, and [`getDatasetDesign()`](https://pavlidislab.github.io/gemma.R/reference/getDatasetDesign.html) to get a matrix with the experimental design. Finally
