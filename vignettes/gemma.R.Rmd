---
title: 'Accessing curated expression data with gemma.R'
author: 'Javier Castillo-Arnemann'
date: "February 18, 2022"
output: rmarkdown::html_vignette
vignette: >
    %\VignetteIndexEntry{Accessing curated expression data with gemma.R}
...
We are left with two datasets, and we'll pick [GSE35974](https://gemma.msl.ubc.ca/expressionExperiment/showExpressionExperiment.html?id=5939) since it has the larger number of samples. Now that we have the ID for our experiment, we can fetch the data associated with it.
...
ggplot(
    ...
    geom_vline(xintercept = c(-0.4, 0.4), col = "gray45", linetype = "dashed") +
...
The unlabeled colored points in the volcano plot correspond to microarray probes that do
