...
- name: Javier Castillo-Arnemann
  ...
  email: javiercastilloar@gmail.com
...
```{r boxplot, fig.cap="Expression profiles of bipolar patients during manic phase and controls."}
...
getDatasetsInfo(datasets = c("GSE35974", "GSE46416")) %>%
    select(ee.ShortName, ee.Name, ee.ID, ee.Accession, 
        ee.Database, ee.Samples, taxon.Name)
```
