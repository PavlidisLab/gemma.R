...
All datasets belonging to a taxon of interest can be accessed by using [`get_dataset`](https://pavlidislab.github.io/gemma.R/reference/get_taxon_datasets.html)
...
search_datasets('http://purl.obolibrary.org/obo/MONDO_0004985', # ontology term URI for the bipolar disorder
                taxon = 'human') %>% 
    select(experiment.ShortName, experiment.Name,taxon.Name) %>% head
```
