...
results <- get_datasets(uris = 'http://purl.obolibrary.org/obo/MONDO_0005180',
...
```
```{r,include = FALSE}
results <- results %>% filter(experiment.ID %in% c(549L, 873L, 1090L, 1869L, 1881L, 1885L, 2412L, 3886L, 3887L, 
3888L, 5670L, 5806L, 5808L, 6484L, 9494L, 12120L, 12123L, 12709L, 
12743L, 13122L, 15666L, 15905L, 16576L, 17290L, 19160L, 20509L, 
23458L, 23683L, 23781L, 24361L, 24651L, 25096L, 25626L, 25781L, 
25905L, 25956L, 26757L))
```
...
and it should have "<http://purl.obolibrary.org/obo/MONDO_0005180>" in it's experimental.factor as the URI for a factor.
