---
title: "Using the Gemma API R Wrapper"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using the Gemma API R Wrapper}
...
## 2 Using the Gemma API R Wrapper 
...
For quick exploration and visualization, we recommend exploring the data in tidy format
...
You'll be able to tell which endpoints accept multiple inputs from the function examples in 
the documentation or simply because the the parameter name is plural (ie. `datasets`, `platforms`).
