...
# get_platform_annotations is now generated from inst/script/registry.R, using
# the platforms/{platform}/annotations REST endpoint instead of the
# arrays/downloadAnnotationFile.html page of the web interface.
