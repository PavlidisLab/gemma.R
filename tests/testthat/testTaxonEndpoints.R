test_that("getTaxa queries work", {
    ...
    expect_equal(
        dat[, c(taxon.Name, taxon.Scientific, taxon.ID, taxon.NCBI, taxon.Database.Name)],
...
test_that("getTaxonPhenotypeCandidates queries work", {
    ...
    expect_type(raw, "list")
    expect_equal(
        dat[, c(gene.Name, gene.NCBI, taxon.Name)],
...
test_that("getGeneOnTaxon queries work", {
    ...
    expect_type(raw, "list")
    expect_equal(
        dat[, c(gene.NCBI, gene.Name, taxon.ID, taxon.Scientific)],
...
test_that("getGeneLocationOnTaxon queries work", {
    ...
    expect_type(raw, "list")
    expect_equal(
        dat[, c(chromosome, strand, nucleotide, taxon.Name, taxon.Database.Name)],
...
test_that("getGenesAtLocation queries work", {
    ...
    expect_type(raw, "list")
    expect_equal(
        dat[, c(gene.Symbol, gene.NCBI, gene.Name, taxon.ID, taxon.Scientific)],
